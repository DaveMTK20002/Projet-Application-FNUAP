...
choix = st.sidebar.radio("Sélectionner la culture :", ["Maïs", "Blé tendre", "Orge","Tournesol","Bettrave à sucre"])
...
if choix == "Maïs":
    st.header("Maïs")
    st.write("Entrez les caractéristiques du sol et validez avec le bouton Prédire.")
